...
void history_diff_add_test_p8(int);
void history_diff_add_test_p9(int);
void history_diff_add_test_p10(int);
...
void history_undo_test_p5(int);
void history_undo_test_p6(int);
void history_undo_test_p7(int);
void history_undo_test_p8(int);
void history_undo_test_p9(int);
void history_undo_test_p10(int);
void history_undo_test_p11(int);
void history_undo_test_p12(int);
...
void history_undo_test_p18(int);
void history_undo_test_p19(int);
