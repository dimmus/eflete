 ...
 *         value, that was setted at step 8 of precondition.
 * </td>
 ...
 * @step 13 Cancel all changes with history_undo function
 *
 * @procedure
 * @step 1 Call history_redo for object from step 5 of precondition.
 * @step 2 Check returned value.
 ...
 *         value, that was setted at step 11 of precondition.
 * </td>
 ...
 * @step 5 Create edje edit object, that will be source of changes.
 * @step 6 Register in history object created at step 5, as module.
 * @step 7 Save current value of  min height param of group.
 * @step 8 Set new value [10] for min height param of group.
 * @step 9 Store diff with using history_diff_add function.
 * @step 10 Cancel change with history_undo function.
 *
 * @procedure
...
EFLETE_TEST(history_redo_test_p9)
{
   ...
   edje_object_file_set(source, path, "elm/radio/base/def");
   history_module_add(source);
   old_value = edje_edit_group_min_h_get(source);
   edje_edit_group_min_h_set(source, new_value);
   ...
   check_value = edje_edit_group_min_h_get(source);
 ...
 * @step 9 Cancel change with history_undo function.
 *
 * @procedure
 * @step 1 Call history_redo for object from step 5 of precondition.
 * @step 2 Check returned value.
...
EFLETE_TEST(history_redo_test_p10)
{
   ...
   result = edje_edit_part_exist(source, new_value);
