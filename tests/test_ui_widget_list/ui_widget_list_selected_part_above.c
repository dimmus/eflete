...
EFLETE_TEST (ui_widget_list_selected_part_above_test_p)
{
   ...
   project = pm_project_open("./ui_widget_list_selected_part_above_test_p/ui_widget_list_selected_part_above_test_p.pro");
...
EFLETE_TEST (ui_widget_list_selected_part_above_test_n1)
{
   ...
   parent = elm_win_add(NULL, "test", ELM_WIN_BASIC);
   project = pm_project_open("./ui_widget_list_selected_part_above_test_n1/ui_widget_list_selected_part_above_test_n1.pro");
   widget_list = ui_widget_list_add(parent);
   ui_widget_list_data_set(widget_list, project);
   /********Choosing widget, so widget list contain parts********/
   /* Double-click on widget*/
...
EFLETE_TEST (ui_widget_list_selected_part_above_test_n2)
{
   ...
   parent = elm_win_add(NULL, "test", ELM_WIN_BASIC);
   project = pm_project_open("./ui_widget_list_selected_part_above_test_n2/ui_widget_list_selected_part_above_test_n2.pro");
   widget_list = ui_widget_list_add(parent);
   ui_widget_list_data_set(widget_list, project);
   /********Choosing widget, so widget list contain parts********/
   /* Double-click on widget*/
...
EFLETE_TEST (ui_widget_list_selected_part_above_test_n3)
{
   ...
   parent = elm_win_add(NULL, "test", ELM_WIN_BASIC);
   project = pm_project_open("./ui_widget_list_selected_part_above_test_n3/ui_widget_list_selected_part_above_test_n3.pro");
   widget_list = ui_widget_list_add(parent);
   ui_widget_list_data_set(widget_list, project);
   /********Choosing widget, so widget list contain parts********/
   /* Double-click on widget*/
