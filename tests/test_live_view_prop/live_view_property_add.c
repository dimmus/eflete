...
EFLETE_TEST(live_view_property_add_test_p)
{
   ...
   live = live_view_property_add(parent);
 ...
 * <tr>
 * <td>live_view_property_add</td>
 * <td>live_view_property_add_test_n</td>
 * <td>
 * @precondition
 * @step 1 Initialize elementary library.
 *
 ...
 * @}
 */
EFLETE_TEST(live_view_property_add_test_n)
{
   Evas_Object *live = NULL;

   elm_init(0, 0);

   live = live_view_property_add(NULL);
   ck_assert_msg(live == NULL, "Live view property object was created "
