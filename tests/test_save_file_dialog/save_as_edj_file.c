 ...
 * @{
 * <tr>
 * <td>save_as_edj_file</td>
 * <td>save_as_edj_file_test_n1</td>
 * <td>
 * @precondition
 ...
 * <tr>
 * <td>save_as_edj_file</td>
 * <td>save_as_edj_file_test_n2</td>
 * <td>
 * @precondition
 * @step 1 initialize elementary library
 * @step 2 initialize application with app_init() function
 ...
 * <tr>
 * <td>save_as_edj_file</td>
 * <td>save_as_edj_file_test_n3</td>
 * <td>
 * @precondition
 * @step 1 initialize elementary library
 *
 * @procedure
 * @step 1 Call function save_as_edj_file(NULL).
 * @step 2 Check returned value.
 * </td>
 * <td>NULL</td>
 * <td>EINA_FALSE</td>
 ...
 * @}
 */
EFLETE_TEST (save_as_edj_file_test_n3)
{
   elm_init(0, 0);
   Eina_Bool result = EINA_FALSE;

   result = save_as_edj_file(NULL);
   ck_assert_msg(result == EINA_FALSE, "'Save as edj' dialog was created");
