...
EFLETE_TEST(workspace_object_area_visible_get_test_p1)
{
   ...
   edje_object_file_set(style->obj, "./edj_build/workspace_object_area_visible_get.edj",
                        style->full_group_name);
   //workspace_edit_object_set(workspace, style, "./edj_build/workspace_object_area_visible_get.edj");
...
EFLETE_TEST(workspace_object_area_visible_get_test_p2)
{
   ...
   res = workspace_object_area_visible_get(workspace);
   ck_assert_msg(res == EINA_FALSE, "Failed getting visibility of object area");
