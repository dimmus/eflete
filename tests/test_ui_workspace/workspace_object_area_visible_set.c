...
EFLETE_TEST(workspace_object_area_visible_set_test_p1)
{
   ...
   edje_object_file_set(style->obj, "./edj_build/workspace_object_area_visible_set.edj",
                        style->full_group_name);
   //workspace_edit_object_set(workspace, style, "./edj_build/workspace_object_area_visible_set.edj");

   res = workspace_object_area_visible_set(workspace, EINA_TRUE);
   ck_assert_msg(res == EINA_TRUE, "Failed setting visibility for object area");
