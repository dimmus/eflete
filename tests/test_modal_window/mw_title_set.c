 ...
 * @}
 */
EFLETE_TEST (mw_title_set_test_p)
{
   Evas_Object *mw;
   App_Data *app;
 ...
 * <tr>
 * <td>mw_title_set</td>
 * <td>mw_title_set_n1</td>
 * <td>
 * @precondition
 * @step 1 initialized efl and app
 *
 * @procedure
 * @step 1 Call mw_title_set(NULL, "new_modal_window")
 * @step 2 Check returned value
 * </td>
 ...
 * @}
 */
EFLETE_TEST (mw_title_set_test_n1)
{
   elm_init(0,0);
   app_init();

   ck_assert_msg(mw_title_set(NULL, "new_modal_window") == EINA_FALSE, "Trying to set"
 ...
 * @}
 */
EFLETE_TEST (mw_title_set_test_n2)
{
   Evas_Object *mw;
   App_Data *app;
