...
EFLETE_TEST (highlight_object_follow_test_n1)
{
   ...
   ck_assert_msg(!highlight_object_follow(bg, object), "Not highlight object now follow another object");
...
EFLETE_TEST (highlight_object_follow_test_n2)
{
   ...
   ck_assert_msg(!highlight_object_follow(highlight, NULL), "Highlight followed NULL object");
...
EFLETE_TEST (highlight_object_follow_test_n3)
{
   ...
   ck_assert_msg(!highlight_object_follow(NULL, object), "NULL following some object");
...
EFLETE_TEST (highlight_object_follow_test_n4)
{
   ...
   ck_assert_msg(!highlight_object_follow(NULL, NULL), "NULL following some object");
