 ...
 * <tr>
 * <td>pm_style_resource_export</td>
 * <td>pm_style_resource_export_test_n1</td>
 * <td>
 * This test check the export style resources  procedure.<br>
 * @precondition
 * @step 1 Initialize elementary library.
 ...
 * @step 2 Check returned value.
 * </td>
 * <td>NULL, (Style *)style, (Eina_Stringshare *)path</td>
 * <td>EINA_FALSE returned</td>
 * </tr>
 * @}
 */

EFLETE_TEST(pm_style_resource_export_test_n1)
{
   App_Data *ap = NULL;
   ...
   elm_init(0,0);
   app_init();
   setup("pm_style_resource_export_test_n1");
   path = eina_stringshare_add("./pm_style_resource_export_test_n1/export");
   ecore_file_mkdir(path);

   ap = app_data_get();
   ui_main_window_add(ap);
   ap->project = pm_project_open("./pm_style_resource_export_test_n1/"
                                  "pm_style_resource_export_test_n1.pro");
   wm_widgets_list_objects_load(ap->project->widgets,
                                evas_object_evas_get(ap->win),
                                ap->project->mmap_file);
   style = wm_style_object_find(ap->project->widgets, "elm/radio/base/def");
   ...
   result = pm_style_resource_export(NULL, style, path);
   ck_assert_msg(!result, "Exported resources without project");

   pm_project_close(ap->project);
   ap->project = NULL;
   ui_main_window_del(ap);
   app_shutdown();
   teardown("./pm_style_resource_export_test_n1");
   eina_stringshare_del(path);
   elm_shutdown();
}
END_TEST
 ...
 * <tr>
 * <td>pm_style_resource_export</td>
 * <td>pm_style_resource_export_test_n2</td>
 * <td>
 * This test check the export style resources  procedure.<br>
 * @precondition
 * @step 1 Initialize elementary library.
 ...
 * @step 2 Check returned value.
 * </td>
 * <td>(Project *)ap->project, NULL, (Eina_Stringshare *)path</td>
 * <td>EINA_FALSE returned</td>
 * </tr>
 * @}
 */

EFLETE_TEST(pm_style_resource_export_test_n2)
{
   App_Data *ap = NULL;
   Eina_Bool result = EINA_TRUE;
   Eina_Stringshare *path = NULL;
   ...
   elm_init(0,0);
   app_init();
   setup("pm_style_resource_export_test_n2");
   path = eina_stringshare_add("./pm_style_resource_export_test_n2/export");
   ecore_file_mkdir(path);

   ap = app_data_get();
   ui_main_window_add(ap);
   ap->project = pm_project_open("./pm_style_resource_export_test_n2/"
                                  "pm_style_resource_export_test_n2.pro");
   wm_widgets_list_objects_load(ap->project->widgets,
                                evas_object_evas_get(ap->win),
                                ap->project->mmap_file);

   result = pm_style_resource_export(ap->project, NULL, path);
   ck_assert_msg(!result, "Exported resources without style");

   pm_project_close(ap->project);
   ap->project = NULL;
   ui_main_window_del(ap);
   app_shutdown();
   teardown("./pm_style_resource_export_test_n2");
   eina_stringshare_del(path);
   elm_shutdown();
}
END_TEST
 ...
 * <tr>
 * <td>pm_style_resource_export</td>
 * <td>pm_style_resource_export_test_n3</td>
 * <td>
 * This test check the export style resources  procedure.<br>
 * @precondition
 * @step 1 Initialize elementary library.
 ...
 * @step 2 Check returned value.
 * </td>
 * <td>(Project *)ap->project, (Style *)style, NULL</td>
 * <td>EINA_FALSE returned</td>
 * </tr>
 * @}
 */

EFLETE_TEST(pm_style_resource_export_test_n3)
{
   App_Data *ap = NULL;
   Eina_Bool result = EINA_TRUE;
   Style *style = NULL;
   ...
   elm_init(0,0);
   app_init();
   setup("pm_style_resource_export_test_n3");

   ap = app_data_get();
   ui_main_window_add(ap);
   ap->project = pm_project_open("./pm_style_resource_export_test_n3/"
                                  "pm_style_resource_export_test_n3.pro");
   wm_widgets_list_objects_load(ap->project->widgets,
                                evas_object_evas_get(ap->win),
                                ap->project->mmap_file);
   style = wm_style_object_find(ap->project->widgets, "elm/radio/base/def");
   ...
   result = pm_style_resource_export(ap->project, style, NULL);
   ck_assert_msg(!result, "Exported resources without path");

   pm_project_close(ap->project);
   ap->project = NULL;
   ui_main_window_del(ap);
   app_shutdown();
   teardown("./pm_style_resource_export_test_n3");
   elm_shutdown();
}
END_TEST
