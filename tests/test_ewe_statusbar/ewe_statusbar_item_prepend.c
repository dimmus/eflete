 ...
 * @{
 * @addtogroup ewe_statusbar_item_prepend
 * @{
 * ewe_statusbar
 * <TABLE>
 * @}
 ...
 * @{
 * <tr>
 * <td>ewe_statusbar_item_prepend</td>
 * <td>ewe_statusbar_item_prepend_test_p1</td>
 * <td>
 * @precondition
 ...
 *
 * @procedure
 * @step 1 Call ewe_statusbar_item_prepend. With EWE_STATUSBAR_ITEM_TYPE_OBJECT.
 ...
 * @}
 */
EFLETE_TEST(ewe_statusbar_item_prepend_test_p1)
{
   ...
   sb_item_f = ewe_statusbar_item_prepend(statusbar, progressbar,
                             EWE_STATUSBAR_ITEM_TYPE_OBJECT, NULL, NULL);
   ck_assert_msg(sb_item_f != NULL, "Failed to prepend new item to statusbar");
   items_list = ewe_statusbar_items_list_get(statusbar);
   ck_assert_msg(items_list != NULL, "After prepend new item to statusbar, NULL "
   ...
   sb_item_f = ewe_statusbar_item_prepend(statusbar, label,
                             EWE_STATUSBAR_ITEM_TYPE_OBJECT, NULL, NULL);
   items_list = ewe_statusbar_items_list_get(statusbar);
   ck_assert_msg(items_list != NULL, "After prepend new item to statusbar, NULL "
                                     "list of items returned");
   ...
   ck_assert_msg(items_count == 2, "Returned list contain different count of "
                                   " setted items");
   sb_item_s = (Ewe_Statusbar_Item *)eina_list_nth(items_list, 0);
   ck_assert_msg(sb_item_f == sb_item_s, "Last setted and first getted items are "
                                         " not equal");
 ...
 * <tr>
 * <td>ewe_statusbar_item_prepend</td>
 * <td>ewe_statusbar_item_prepend_test_p2</td>
 * <td>
 * @precondition
 * @step 1 Initialize EWE library.
 * @step 2 Create parent window.
 ...
 *
 * @procedure
 * @step 1 Call ewe_statusbar_item_prepend. With EWE_STATUSBAR_ITEM_TYPE_SEPARATOR.
 * @step 2 Check returned value.
 * @step 3 Call ewe_statusbar_items_list_get
 * @step 4 Check list of items on NULL.
 * @step 5 Get item from items list.
 ...
 * @}
 */
EFLETE_TEST(ewe_statusbar_item_prepend_test_p2)
{
   Evas_Object *win = NULL;
   Evas_Object *statusbar = NULL;
   Evas_Object *progressbar = NULL;
   ...
   ck_assert_msg(sb_item_f != NULL, "Failed to prepend new separator to statusbar");
   items_list = ewe_statusbar_items_list_get(statusbar);
   ck_assert_msg(items_list != NULL, "After prepend new separator to statusbar, "
 ...
 * <tr>
 * <td>ewe_statusbar_item_prepend</td>
 * <td>ewe_statusbar_item_prepend_test_p3</td>
 * <td>
 * @precondition
...
EFLETE_TEST(ewe_statusbar_item_prepend_test_p3)
{
   Evas_Object *win = NULL;
   Evas_Object *statusbar = NULL;
   Evas_Object *progressbar = NULL;
   ...
   sb_item = ewe_statusbar_item_prepend(statusbar, progressbar,
                             EWE_STATUSBAR_ITEM_TYPE_OBJECT, test_callback,
                             (char *)cb_data);
   ck_assert_msg(sb_item != NULL, "Failed to prepend new item to statusbar");
   items_list = ewe_statusbar_items_list_get(statusbar);
   ck_assert_msg(items_list != NULL, "After prepend new item to statusbar, "
                                     "NULL list of items returned");
   sb_item_s = (Ewe_Statusbar_Item *)eina_list_data_get(items_list);
 ...
 * <tr>
 * <td>ewe_statusbar_item_prepend</td>
 * <td>ewe_statusbar_item_prepend_test_p4</td>
 * <td>
 * @precondition
 * @step 1 Initialize EWE library.
 * @step 2 Create parent window.
 ...
 * @}
 */
EFLETE_TEST(ewe_statusbar_item_prepend_test_p4)
{
   Evas_Object *win = NULL;
   Evas_Object *statusbar = NULL;
   Evas_Object *content = NULL;
   ...
   sb_item_f = ewe_statusbar_item_prepend(statusbar, NULL,
                             EWE_STATUSBAR_ITEM_TYPE_OBJECT, NULL, NULL);
   ck_assert_msg(sb_item_f != NULL, "Failed to prepend new item to statusbar");
   items_list = ewe_statusbar_items_list_get(statusbar);
   ck_assert_msg(items_list != NULL, "After prepend new item to statusbar, NULL "
 ...
 * <tr>
 * <td>ewe_statusbar_item_prepend</td>
 * <td>ewe_statusbar_item_prepend_test_n1</td>
 * <td>
 * @precondition
 * @step 1 Initialize EWE library.
 *
 ...
 * @}
 */
EFLETE_TEST(ewe_statusbar_item_prepend_test_n1)
{
   Ewe_Statusbar_Item *sb_item = NULL;

   ewe_init(0, 0);

   sb_item = ewe_statusbar_item_prepend(NULL, NULL,
                             EWE_STATUSBAR_ITEM_TYPE_OBJECT, NULL, NULL);
   ck_assert_msg(sb_item == NULL, "Prepend new item without statusbar");
 ...
 * <tr>
 * <td>ewe_statusbar_item_prepend</td>
 * <td>ewe_statusbar_item_prepend_test_n2</td>
 * <td>
 * @precondition
 * @step 1 Initialize EWE library.
 * @step 2 Create parent window.
 ...
 *
 * @procedure
 * @step 1 Call ewe_statusbar_item_prepend.
 * @step 2 Check returned value.
 * </td>
 ...
 * @}
 */
EFLETE_TEST(ewe_statusbar_item_prepend_test_n2)
{
   Evas_Object *win = NULL;
   Evas_Object *statusbar = NULL;
   Ewe_Statusbar_Item *sb_item = NULL;
   ...
   sb_item = ewe_statusbar_item_prepend(statusbar, NULL, -1, NULL, NULL);
   ck_assert_msg(sb_item == NULL, "Prepend new item with wrong type");
