 ...
 * @{
 * @addtogroup ewe_statusbar_item_insert_after
 * @{
 * ewe_statusbar
 * <TABLE>
 * @}
 ...
 * @{
 * <tr>
 * <td>ewe_statusbar_item_insert_after</td>
 * <td>ewe_statusbar_item_insert_after_test_p1</td>
 * <td>
 * @precondition
 ...
 *
 * @procedure
 * @step 1 Call ewe_statusbar_item_insert_after. Inserting item from step 6 of
 *         precondition after item from step 8 of precondition.
 * @step 2 Check returned value.
 * @step 3 Call ewe_statusbar_items_list_get
 * @step 4 Check list of items on NULL.
 * @step 5 Get last item from items list.
 ...
 * </td>
 * <td>(Evas_Object *)statusbar, (Ewe_Statusbar_Item *)item, (Ewe_Statusbar_Item *)after</td>
 ...
 * @}
 */
EFLETE_TEST(ewe_statusbar_item_insert_after_test_p1)
{
   ...
   ret = ewe_statusbar_item_insert_after(statusbar, item_p, item_l);
   ck_assert_msg(ret == EINA_TRUE, "Failed to insert first item after after last");
   items_list = ewe_statusbar_items_list_get(statusbar);
   ck_assert_msg(items_list != NULL, "List of items is NULL");
   control = (Ewe_Statusbar_Item *)eina_list_data_get(eina_list_last(items_list));
   ck_assert_msg(item_p == control, "Last item not equal to reordered item");
 ...
 * <tr>
 * <td>ewe_statusbar_item_insert_after</td>
 * <td>ewe_statusbar_item_insert_after_test_p2</td>
 * <td>
 * @precondition
 * @step 1 Initialize EWE library.
 * @step 2 Create parent window.
 ...
 * @procedure
 * @step 1 Call ewe_statusbar_item_insert_after. Inserting item from step 6 of
 *         precondition after item from step 7 of precondition.
 * @step 2 Check returned value.
 * @step 3 Call ewe_statusbar_items_list_get
 * @step 4 Check list of items on NULL.
 ...
 * @}
 */
EFLETE_TEST(ewe_statusbar_item_insert_after_test_p2)
{
   Evas_Object *win = NULL;
   Evas_Object *statusbar = NULL;
   Evas_Object *progressbar = NULL;
   ...
   ewe_statusbar_item_append(statusbar, label, EWE_STATUSBAR_ITEM_TYPE_OBJECT,
                             NULL, NULL);

   ret = ewe_statusbar_item_insert_after(statusbar, item_p, item_s);
   ck_assert_msg(ret == EINA_TRUE, "Failed to insert first item after second");
   items_list = ewe_statusbar_items_list_get(statusbar);
   ck_assert_msg(items_list != NULL, "List of items is NULL");
 ...
 * <tr>
 * <td>ewe_statusbar_item_insert_after</td>
 * <td>ewe_statusbar_item_insert_after_test_p3</td>
 * <td>
 * @precondition
 * @step 1 Initialize EWE library.
 * @step 2 Create parent window.
 ...
 *
 * @procedure
 * @step 1 Call ewe_statusbar_item_insert_after. Inserting item from step 8 of
 *         precondition after item from step 6 of precondition.
 * @step 2 Check returned value.
 * @step 3 Call ewe_statusbar_items_list_get
 * @step 4 Check list of items on NULL.
 * @step 5 Get second item from items list.
 ...
 * @}
 */
EFLETE_TEST(ewe_statusbar_item_insert_after_test_p3)
{
   Evas_Object *win = NULL;
   Evas_Object *statusbar = NULL;
   Evas_Object *progressbar = NULL;
   ...
   ret = ewe_statusbar_item_insert_after(statusbar, item_l, item_p);
   ck_assert_msg(ret == EINA_TRUE, "Failed to insert third item after first");
   items_list = ewe_statusbar_items_list_get(statusbar);
   ck_assert_msg(items_list != NULL, "List of items is NULL");
   control = (Ewe_Statusbar_Item *)eina_list_nth(items_list, 1);
 ...
 * <tr>
 * <td>ewe_statusbar_item_insert_after</td>
 * <td>ewe_statusbar_item_insert_after_test_p4</td>
 * <td>
 * @precondition
 * @step 1 Initialize EWE library.
 * @step 2 Create parent window.
 ...
 *
 * @procedure
 * @step 1 Call ewe_statusbar_item_insert_after. Inserting item from step 7 of
 *         precondition after item from step 8 of precondition.
 * @step 2 Check returned value.
 * @step 3 Call ewe_statusbar_items_list_get
 * @step 4 Check list of items on NULL.
 ...
 * @}
 */
EFLETE_TEST(ewe_statusbar_item_insert_after_test_p4)
{
   Evas_Object *win = NULL;
   Evas_Object *statusbar = NULL;
   Evas_Object *progressbar = NULL;
   ...
   ret = ewe_statusbar_item_insert_after(statusbar, item_s, item_l);
   ck_assert_msg(ret == EINA_TRUE, "Failed to insert separator item after last");
   items_list = ewe_statusbar_items_list_get(statusbar);
   ck_assert_msg(items_list != NULL, "List of items is NULL");
   control = (Ewe_Statusbar_Item *)eina_list_data_get(eina_list_last(items_list));
   ck_assert_msg(item_s == control, "Last item not equal to reordered item");
 ...
 * <tr>
 * <td>ewe_statusbar_item_insert_after</td>
 * <td>ewe_statusbar_item_insert_after_test_n1</td>
 * <td>
 * @precondition
 * @step 1 Initialize EWE library.
 * @step 2 Create parent window.
 ...
 *
 * @procedure
 * @step 1 Call ewe_statusbar_item_insert_after.
 * @step 2 Check returned value.
 * </td>
 * <td>NULL, (Ewe_Statusbar_Item *)item, (Ewe_Statusbar_Item *)after</td>
 ...
 * @}
 */
EFLETE_TEST(ewe_statusbar_item_insert_after_test_n1)
{
   Evas_Object *win = NULL;
   Evas_Object *statusbar = NULL;
   Evas_Object *progressbar = NULL;
   ...
   ret = ewe_statusbar_item_insert_after(NULL, item_s, item_l);
 ...
 * <tr>
 * <td>ewe_statusbar_item_insert_after</td>
 * <td>ewe_statusbar_item_insert_after_test_n2</td>
 * <td>
 * @precondition
 * @step 1 Initialize EWE library.
 * @step 2 Create parent window.
 ...
 * @step 2 Check returned value.
 * </td>
 * <td>(Evas_Object *)statusbar, NULL, (Ewe_Statusbar_Item *)after</td>
 * <td>EINA_FALSE returned</td>
 * <td>_REAL_RESULT_</td>
 * <td>_PASSED_</td>
 * </tr>
 * @}
 */
EFLETE_TEST(ewe_statusbar_item_insert_after_test_n2)
{
   Evas_Object *win = NULL;
   Evas_Object *statusbar = NULL;
   Evas_Object *progressbar = NULL;
   ...
   ret = ewe_statusbar_item_insert_after(statusbar, NULL, item_l);
 ...
 * <tr>
 * <td>ewe_statusbar_item_insert_after</td>
 * <td>ewe_statusbar_item_insert_after_test_n3</td>
 * <td>
 * @precondition
 * @step 1 Initialize EWE library.
 * @step 2 Create parent window.
 ...
 * @}
 */
EFLETE_TEST(ewe_statusbar_item_insert_after_test_n3)
{
   Evas_Object *win = NULL;
   Evas_Object *statusbar = NULL;
   Evas_Object *progressbar = NULL;
   ...
   ret = ewe_statusbar_item_insert_after(statusbar, item_l, NULL);
   ck_assert_msg(ret == EINA_FALSE, "Change order of items with after item NULL");
 ...
 * <tr>
 * <td>ewe_statusbar_item_insert_after</td>
 * <td>ewe_statusbar_item_insert_after_test_n4</td>
 * <td>
 * @precondition
 * @step 1 Initialize EWE library.
 * @step 2 Create parent window.
 ...
 * @procedure
 * @step 1 Call ewe_statusbar_item_insert_after. Inserting item from step 7 of
 *         precondition after item from step 9 of precondition. Using object
 ...
 * @}
 */
EFLETE_TEST(ewe_statusbar_item_insert_after_test_n4)
{
   Evas_Object *win = NULL;
   Evas_Object *statusbar = NULL;
 ...
 * <tr>
 * <td>ewe_statusbar_item_insert_after</td>
 * <td>ewe_statusbar_item_insert_after_test_n5</td>
 * <td>
 * @precondition
 * @step 1 Initialize EWE library.
 * @step 2 Create parent window.
 ...
 * @procedure
 * @step 1 Call ewe_statusbar_item_insert_after. Inserting item from step 7 of
 *         precondition after item from step 8 of precondition. Using object
 ...
 * </td>
 * <td>(Evas_Object *)statusbar_2, (Ewe_Statusbar_Item *)item, (Ewe_Statusbar_Item *)after</td>
 * <td>All checks passed</td>
 * <td>_REAL_RESULT_</td>
 * <td>_PASSED_</td>
 * </tr>
 * @}
 */
EFLETE_TEST(ewe_statusbar_item_insert_after_test_n5)
{
   Evas_Object *win = NULL;
   Evas_Object *statusbar = NULL;
   Evas_Object *statusbar_2 = NULL;
   ...
   ret = ewe_statusbar_item_insert_after(statusbar_2, item_p, item_s);
 ...
 * <tr>
 * <td>ewe_statusbar_item_insert_after</td>
 * <td>ewe_statusbar_item_insert_after_test_n6</td>
 * <td>
 * @precondition
 * @step 1 Initialize EWE library.
 * @step 2 Create parent window.
 ...
 * @}
 */
EFLETE_TEST(ewe_statusbar_item_insert_after_test_n6)
{
   Evas_Object *win = NULL;
   Evas_Object *statusbar = NULL;
   Evas_Object *progressbar = NULL;
   ...
   ret = ewe_statusbar_item_insert_after(statusbar, item_p, item_p);
   ck_assert_msg(ret == EINA_FALSE, "Item was moved after itself");
   items_list = ewe_statusbar_items_list_get(statusbar);
   ck_assert_msg(items_list != NULL, "List of items frist statusbar is NULL");
   items_count = eina_list_count(items_list);
