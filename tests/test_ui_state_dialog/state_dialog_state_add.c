 ...
 * <td>state_dialog_state_add_test_p1</td>
 * <td>
 * @precondition
 ...
 * @}
 */
EFLETE_TEST (state_dialog_state_add_test_p1)
{
   elm_init(0, 0);
   App_Data *app_data;
   Evas_Object *popup;
 ...
 * <tr>
 * <td>state_dialog_state_add</td>
 * <td>state_dialog_state_add_test_p2</td>
 * <td>
 * @precondition
 * @step 1 initialize elementary library
 * @step 2 initialize application with app_init() function
 ...
 * @}
 */
EFLETE_TEST (state_dialog_state_add_test_p2)
{
   elm_init(0, 0);
   App_Data *app_data;
   Evas *canvas;
