...
typedef enum {
   ...
   ATTRIBUTE_TEXTBLOCK_ITEM_POSITION_TITLE,
   ...
   ATTRIBUTE_TEXTBLOCK_ITEM_FORMAT_TITLE,
   ...
   ATTRIBUTE_TEXTBLOCK_ITEM_GLOW_SHADOW_TITLE,
   ...
   ATTRIBUTE_TEXTBLOCK_ITEM_LINES_TITLE,
...
typedef enum {
   ...
   PROPERTY_TEXTBLOCK_ITEM_LINES_UNDERLINE_COLOR,
