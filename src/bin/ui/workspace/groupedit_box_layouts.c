...
void
_box_layout_homogeneous_horizontal(Evas_Box *o, Evas_Object_Box_Data *priv, void *data __UNUSED__)
{
...
void
_box_layout_homogeneous_vertical(Evas_Box *o, Evas_Object_Box_Data *priv, void *data __UNUSED__)
{
   int cell_sz, share, inc;
   int sub_pixel = 0;
   int x, y, w, h;
...
void
_box_layout_homogeneous_max_size_vertical(Evas_Box *o, Evas_Object_Box_Data *priv, void *data __UNUSED__)
{
   int remaining, global_pad, pad_inc = 0, sub_pixel = 0;
   int cell_sz = 0;
   int x, y, w, h;
